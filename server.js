...
const { dbAddCustomer, dbAddOrder, dbCreateOrderWithCustomer } = require('./database.js')
...
app.post('/webhook', express.raw({ type: 'application/json' }), async (req, res) => {
    ...
    try {
        ...
        if (event.type === 'checkout.session.completed') {
            ...
            //wysylka maila
            sendMailFunc(customerData.customerName, customerData.customerEmail, orderData.sessionId)
